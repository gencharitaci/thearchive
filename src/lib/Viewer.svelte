...
<div id="imgtitle"
  ...
  <div class="flex justify-center items-center">
    <div class="hidden lg:block mr-2 text-sm">
      Download
    </div>
    <div class="mb-1">
...
{#if historicInfo}
<div class="absolute top-24 bottom-3 left-2 w-52 z-50 flex flex-col justify-end">
  <div class=" bg-white/90 rounded-md p-3 text-xs text-center overflow-y-auto drop-shadow-lg shadow-lg" transition:fade>
